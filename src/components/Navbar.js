        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <div className={`form-check form-switch text-${props.darkMode === "light"?"dark":"light"} mx-2`}>
          ...
          <div className="d-flex">
            <div className="bg-primary rounded mx-2 my-2" onClick={()=>{props.ColorPallete("primary")}} style={{height:"30px",width:"30px", cursor:'pointer'}}></div>
            <div className="bg-success rounded mx-2 my-2" onClick={()=>{props.ColorPallete("success")}} style={{height:"30px",width:"30px", cursor:'pointer'}}></div>
            <div className="bg-warning rounded mx-2 my-2" onClick={()=>{props.ColorPallete("warning")}} style={{height:"30px",width:"30px", cursor:'pointer'}}></div>
            <div className="bg-danger rounded mx-2 my-2" onClick={()=>{props.ColorPallete("danger")}} style={{height:"30px",width:"30px", cursor:'pointer'}}></div>
          </div>
